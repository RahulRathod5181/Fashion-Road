...
const AddressForm = () => {
  ...
  return (
    <Stack bgColor={"white"} borderRadius={".35rem"}
    p={"10px 30px"}
    pl={{ base: "0.3rem", sm: "0.3rem", md: "0.3rem", lg: "30px" }}
    pr={{ base: "0.3rem", sm: "0.3rem", md: "0.3rem", lg: "30px" }}
     as="form">
      <Stack direction={"row"} margin={"auto"} w={'100%'}> 
